...
1. チャット プレイグラウンド ページの **[セットアップ]** ペインで、**gpt-4o** モデルのモデル デプロイが選ばれていることを確認します。
...
1. コード ファイルで、**your_project_endpoint** プレースホルダーをモデルの適切なエンドポイントに置き換え、**your_model_deployment** プレースホルダーを gpt-4o モデル デプロイに割り当てた名前に置き換えます。
